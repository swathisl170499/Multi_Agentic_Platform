...
from multi_agentic_platform.rag.online_embedder import HuggingFaceAPIEmbedder
...
class RAGPipeline:
    ...
    def _create_embedder(self):
        if settings.rag_use_online_inference:
            return HuggingFaceAPIEmbedder(settings.rag_embedding_model)
